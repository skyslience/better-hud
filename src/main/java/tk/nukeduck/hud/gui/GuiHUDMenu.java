...
public class GuiHUDMenu extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(0, hW - 100, yBase - 22, I18n.format("menu.returnToGame")));
		this.buttonList.add(new GuiButton(1, hW - 149, yBase, 98, 20, I18n.format("betterHud.menu.enableAll")));
		this.buttonList.add(new GuiButton(2, hW - 49, yBase, 98, 20, I18n.format("betterHud.menu.disableAll")));
		this.buttonList.add(new GuiButton(3, hW + 51, yBase, 98, 20, I18n.format("betterHud.menu.resetDefaults")));
	...
	public void drawScreen(int mouseX, int mouseY, float p_73863_3_) {
		...
		this.drawCenteredString(this.fontRendererObj, I18n.format("betterHud.menu.hudSettings"), this.width / 2, height / 16 + 5, 16777215);

		this.drawString(this.fontRendererObj, countEnabled(BetterHud.proxy.elements.elements) + "/" + BetterHud.proxy.elements.elements.length + " enabled", 5, 5, Colors.WHITE);
		...
		this.drawCenteredString(this.fontRendererObj, I18n.format("betterHud.menu.page", (currentPage + 1) + "/" + (int) Math.ceil((float) BetterHud.proxy.elements.elements.length / perPage)), width / 2, height - height / 16 - 13, Colors.WHITE);
	}
