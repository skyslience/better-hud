...
public class ExtraGuiElementExperienceInfo extends ExtraGuiElementText {
	...
	public void render(Minecraft mc, ScaledResolution resolution, StringManager stringManager, LayoutManager layoutManager) {
		if(!mc.thePlayer.capabilities.isCreativeMode && !(mc.thePlayer.getRidingEntity() != null && mc.thePlayer.getRidingEntity() instanceof EntityHorse)) {
			...
			drawBorderedString(mc.fontRendererObj, String.valueOf(has), resolution.getScaledWidth() / 2 - 90, resolution.getScaledHeight() - 30, Colors.WHITE); // 30
			drawBorderedString(mc.fontRendererObj, String.valueOf(needed), resolution.getScaledWidth() / 2 + 90 - mc.fontRendererObj.getStringWidth(String.valueOf(needed)), resolution.getScaledHeight() - 30, Colors.WHITE);
		}
