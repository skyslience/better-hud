...
public class ExtraGuiElementClock extends ExtraGuiElement {
	...
	public void render(Minecraft mc, ScaledResolution resolution, StringManager stringManager, LayoutManager layoutManager) {
		...
		String day = I18n.format("betterHud.strings.day", (mc.theWorld.getWorldTime() + 6000) / 24000 + 1);
		String time;
		int h = (int) (t / 1000);
		...
		if(posMode.index == 1) {
			...
			mc.ingameGUI.drawString(mc.fontRendererObj, time, x + 5, y + 5, Colors.WHITE);
			mc.ingameGUI.drawString(mc.fontRendererObj, day, x + 5, y + 7 + mc.fontRendererObj.FONT_HEIGHT, Colors.WHITE);
			...
			switch(pos.value) {
				case TOP_LEFT:
					...
					mc.ingameGUI.drawString(mc.fontRendererObj, time, 5, currentHeight + 5, Colors.WHITE);
					mc.ingameGUI.drawString(mc.fontRendererObj, day, 5, currentHeight + 7 + mc.fontRendererObj.FONT_HEIGHT, Colors.WHITE);
				...
				case TOP_RIGHT:
					...
					mc.ingameGUI.drawString(mc.fontRendererObj, time, resolution.getScaledWidth() - mc.fontRendererObj.getStringWidth(time) - 5, currentHeight + 5, Colors.WHITE);
					mc.ingameGUI.drawString(mc.fontRendererObj, day, resolution.getScaledWidth() - mc.fontRendererObj.getStringWidth(day) - 5, currentHeight + 7 + mc.fontRendererObj.FONT_HEIGHT, Colors.WHITE);
				...
				case BOTTOM_LEFT:
					...
					mc.ingameGUI.drawString(mc.fontRendererObj, time, 5, resolution.getScaledHeight() - currentHeight - staticHeight + 5, Colors.WHITE);
					mc.ingameGUI.drawString(mc.fontRendererObj, day, 5, resolution.getScaledHeight() - currentHeight - staticHeight + 7 + mc.fontRendererObj.FONT_HEIGHT, Colors.WHITE);
				...
				case BOTTOM_RIGHT:
					...
					mc.ingameGUI.drawString(mc.fontRendererObj, time, resolution.getScaledWidth() - mc.fontRendererObj.getStringWidth(time) - 5, resolution.getScaledHeight() - currentHeight - staticHeight + 5, Colors.WHITE);
					mc.ingameGUI.drawString(mc.fontRendererObj, day, resolution.getScaledWidth() - mc.fontRendererObj.getStringWidth(day) - 5, resolution.getScaledHeight() - currentHeight - staticHeight + 7 + mc.fontRendererObj.FONT_HEIGHT, Colors.WHITE);
