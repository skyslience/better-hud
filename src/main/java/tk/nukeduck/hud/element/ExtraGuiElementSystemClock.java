...
public class ExtraGuiElementSystemClock extends ExtraGuiElement {
	...
	public void render(Minecraft mc, ScaledResolution resolution, StringManager stringManager, LayoutManager layoutManager) {
		...
		if(posMode.index == 1) {
			...
			mc.ingameGUI.drawString(mc.fontRendererObj, time, pos2.x + 5, pos2.y + 5, Colors.WHITE);
			mc.ingameGUI.drawString(mc.fontRendererObj, date, pos2.x + 5, pos2.y + 7 + mc.fontRendererObj.FONT_HEIGHT, Colors.WHITE);
		} else if(right) {
			...
			mc.ingameGUI.drawString(mc.fontRendererObj, time, resolution.getScaledWidth() - mc.fontRendererObj.getStringWidth(time) - 5, rightHeight + 5, Colors.WHITE);
			mc.ingameGUI.drawString(mc.fontRendererObj, date, resolution.getScaledWidth() - mc.fontRendererObj.getStringWidth(date) - 5, rightHeight + 7 + mc.fontRendererObj.FONT_HEIGHT, Colors.WHITE);
			...
			mc.ingameGUI.drawString(mc.fontRendererObj, time, 5, leftHeight + 5, Colors.WHITE);
			mc.ingameGUI.drawString(mc.fontRendererObj, date, 5, leftHeight + 7 + mc.fontRendererObj.FONT_HEIGHT, Colors.WHITE);
