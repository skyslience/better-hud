...
public class ElementSettingPosition extends ElementSetting {
	...
	public void render(GuiScreen gui, int yScroll) {
		...
		final int x = middleRight.xPosition + middleRight.width + 5;
		final int y = middleRight.yPosition + (middleRight.height - Minecraft.getMinecraft().fontRendererObj.FONT_HEIGHT) / 2;

		gui.drawString(Minecraft.getMinecraft().fontRendererObj, text, x, y, Colors.WHITE);
	}
