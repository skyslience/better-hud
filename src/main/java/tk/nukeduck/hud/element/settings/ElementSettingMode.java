...
public class ElementSettingMode extends ElementSetting {
	...
	public void render(GuiScreen gui, int yScroll) {
		...
		gui.drawCenteredString(Minecraft.getMinecraft().fontRendererObj, I18n.format("betterHud.setting." + getValue()), last.xPosition + backing.width / 2, last.yPosition + 6, color);
	}
