...
public class ExtraGuiElementCompass extends ExtraGuiElement {
	...
	public void render(Minecraft mc, ScaledResolution resolution, StringManager stringManager, LayoutManager layoutManager) {
		...
		RenderUtil.drawRect(x, y, x + 180, y + 12, Colors.fromARGB(170, 0, 0, 0));
		RenderUtil.drawRect(x + 50, y, x + 130, y + 12, Colors.fromARGB(85, 85, 85, 85));
		...
		if(nOpacity > 10) {
			glPushMatrix(); {
				...
				mc.ingameGUI.drawCenteredString(mc.fontRendererObj, "N", 0, 0, Colors.fromARGB(nOpacity, 255, 0, 0));
			}
			glPopMatrix();
		}
		if(eOpacity > 10) {
			glPushMatrix(); {
				...
				mc.ingameGUI.drawCenteredString(mc.fontRendererObj, "E", 0, 0, Colors.fromARGB(eOpacity, 255, 255, 255));
			}
			glPopMatrix();
		}
		if(sOpacity > 10) {
			glPushMatrix(); {
				...
				mc.ingameGUI.drawCenteredString(mc.fontRendererObj, "S", 0, 0, Colors.fromARGB(sOpacity, 0, 0, 255));
			}
			glPopMatrix();
		}
		if(wOpacity > 10) {
			glPushMatrix(); {
				...
				mc.ingameGUI.drawCenteredString(mc.fontRendererObj, "W", 0, 0, Colors.fromARGB(wOpacity, 255, 255, 255)); // 16777216 = 256^3
			}
			glPopMatrix();
		}
		...
		if(showNotches.value) {
			...
			for(int loc : notchX) {
				RenderUtil.drawRect(x + loc - 1, y - 2, x + loc, y + 4, Colors.WHITE);
				RenderUtil.drawRect(x - loc + 180, y - 2, x - loc + 181, y + 4, Colors.WHITE);
			}
		}
