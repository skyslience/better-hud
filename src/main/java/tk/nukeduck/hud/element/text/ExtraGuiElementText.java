...
public abstract class ExtraGuiElementText extends ExtraGuiElement {
	...
	public void render(Minecraft mc, ScaledResolution resolution, StringManager stringManager, LayoutManager layoutManager) {
		...
		if(posMode.index == 0) {
			...
			this.bounds = RenderUtil.renderStrings(mc.fontRendererObj, text, pos2.x, pos2.y, Colors.fromRGB((int) red.value, (int) green.value, (int) blue.value), Position.TOP_LEFT);
